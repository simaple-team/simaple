...
def test_mechanic_actor():
    ...
    assert (result, dpm) == snapshot(
        (
            {
                "메카 캐리어": 4181420445729.957, 
                "호밍 미사일 VI": 6270932138695.628, 
                "로봇 런처: RM7": 191884986168.90744,
                "마그네틱 필드": 226065333234.9669,
                "로봇 팩토리: RM1": 529365512468.8727, "메탈아머 전탄발사": 2970743884832.0913,
                "마이크로 미사일 컨테이너": 753513150457.3118,
                "디스토션 필드": 330767330345.21027, 
                "그라운드 제로": 4491220023297.706, 
                "레지스탕스 라인 인팬트리": 183270234447.03595, 
                "매시브 파이어: IRON-B VI": 618419312686.8618, 
                "매시브 파이어: IRON-B VI (폭발)": 144654341071.0488},
            8574700058869.541,
        )
    )
