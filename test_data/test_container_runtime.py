...
def run_actor(environment_provider: BaselineEnvironmentProvider, jobtype: JobType):
    ...
    print(f"{engine.get_current_viewer()('clock')} | {jobtype}")
    print(result)
    return result
...
def test_archmagefb_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.archmagefb)
...
def test_archmagetc_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.archmagetc)

    # then
    assert result == snapshot(
        {
            "프로즌 라이트닝": 2181992892893.5176,
            "엘퀴네스": 102170406751.72746,
            "아이스 에이지": 373852320262.6632,
...
def test_bishop_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.bishop)
...
def test_mechanic_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.mechanic)
...
def test_adele_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.adele)
...
def test_windbreaker_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.windbreaker)
...
def test_soulmaster_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.soulmaster)
...
def test_dualblade_actor():
    ...
    # when
    result = run_actor(environment_provider, JobType.dualblade)
