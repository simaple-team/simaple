...
def test_archmagefb_actor():
    ...
    assert (result, dpm) == snapshot(
        (
            {
                "이프리트": 166199978281.65402,
                "인페르날 베놈": 4541495237146.597,
                "파이어 오라": 275610739753.2228,
                "메테오(패시브)": 573921847337.4453,
                "이그나이트": 804640494083.8042,
                "메테오": 87769700407.87178,
                "포이즌 노바": 670890233773.3075,
                "도트 퍼니셔": 960425088338.1971,
                "메기도 플레임": 239237491488.40714,
