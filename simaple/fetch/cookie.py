...
def get_cookie() -> RequestsCookieJar:
    ...
    jar.set("NXLW", "AA7B15B02F2FB38651342AB38213B3B5&PTC=https:&DOM=maplestory.nexon.com&ID=&CP=")
    jar.set("SID", "AA7B15B02F2FB38651342AB38213B3B5&PTC=https:&DOM=maplestory.nexon.com&ID=&CP=")
