...
def test_absolab_17_p30_full(test_case_file):
    ...
    test_case["expected"]["meta"]["boss_reward"] = test_case["expected"].pop("boss_reward")
    test_case["expected"]["meta"]["superior_eqp"] = test_case["expected"].pop("superior_eqp")
    test_case["expected"]["meta"]["req_job"] = test_case["expected"].pop("req_job")
    test_case["expected"]["meta"]["set_item_id"] = test_case["expected"].pop("set_item_id")
    test_case["expected"]["meta"]["type"] = test_case["expected"].pop("type")
    test_case["expected"]["meta"]["base_stat"] = gear_repository.get_by_id(test_case["expected"]["meta"]["id"]).stat.short_dict()
    test_case["expected"]["meta"]["max_scroll_chance"] = test_case["expected"]["scroll_chance"]
